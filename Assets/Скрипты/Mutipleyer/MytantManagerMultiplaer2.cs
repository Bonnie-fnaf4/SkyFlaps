...
public class MytantManagerMultiplaer2 : MonoBehaviour, IPunObservable
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            if (PlayerPrefs.GetInt("SaveMutatorInt") == 1) OffMM = true;
            else OffMM = false;
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
    {
        ...
        else
        {
            ...
            if (OffMM) PlayerPrefs.SetInt("SaveMutatorInt", 1);
        }
    }
    ...
    void Update()
    {
        ...
        c.text = "f = " + f + " a = " + a + " b = " + b + " bb = " + bb + " n1 = " + n1 + " n2 = " + n2 + " n3 = " + n3 + " n22 = " + n22 + " n32 = " + n32 + " BL2.Inver = " + BL2.Inver;
        //if (!act) return;
        ...
        if (!HostP)
        {
            ...
            if (PlayerPrefs.GetInt("SaveMMN1") == 1 && !n1)
            {
            ...
            if (PlayerPrefs.GetInt("SaveMMN2") == 1 && !n2)
            {
                BI.enabled = true;
                BL2.Inver2 = true;
                n2 = true;
            ...
            if (PlayerPrefs.GetInt("SaveMMN3") == 1 && !n3)
            {
                CI.enabled = true;
                BL2.Inver = true;
                n3 = true;
            ...
            if (PlayerPrefs.GetInt("SaveMMN32") == 0 && n32)
            {
                CameraInvers_Off();
                C123_True();
            ...
            if (PlayerPrefs.GetInt("SaveMMN22") == 0 && n22)
            {
                BirdInvers_Off();
                C123_True();
            }
            ...
            if (PlayerPrefs.GetInt("SaveMMN32") == 1 && !n32)
            {
                CameraInvers_On();
                C123_True();

            }
            if (PlayerPrefs.GetInt("SaveMMN22") == 1 && !n22)
            {
                BirdInvers_On();
                C123_True();
